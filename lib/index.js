...
const DEFAULT_MODELS = [
  { id: "qwen3.8-max", name: "Qwen3.8 Max", contextWindow: MEGABYTE_CONTEXT_WINDOW, maxTokens: DEFAULT_MAX_TOKENS },
  { id: "qwen3.7-max", name: "Qwen3.7 Max", contextWindow: MEGABYTE_CONTEXT_WINDOW, maxTokens: DEFAULT_MAX_TOKENS },
  { id: "qwen3.7-flash", name: "Qwen3.7 Flash", contextWindow: MEGABYTE_CONTEXT_WINDOW, maxTokens: DEFAULT_MAX_TOKENS },
  { id: "qwen3.6-plus", name: "Qwen3.6 Plus", contextWindow: MEGABYTE_CONTEXT_WINDOW, maxTokens: DEFAULT_MAX_TOKENS },
  { id: "qwen3.6-flash", name: "Qwen3.6 Flash", contextWindow: MEGABYTE_CONTEXT_WINDOW, maxTokens: DEFAULT_MAX_TOKENS },
